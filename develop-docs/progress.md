...
- ⏳ Sink 连接器（POSTGRESQL / ORACLE / DORIS）开发中
- ⏳ Transform 支持 & 表单验证增强待实现
- ⏳ 后端代码优化待落地
...
| 2025-10-XX | Sink 连接器（JDBC + Doris） | ⏳ 进行中 |
| 2025-10-XX | Transform 支持、表单校验完善 | 📋 待排期 |
...
1. **前端**：完成 Sink 连接器、Transform、校验规则，实现完整流水线配置体验。
